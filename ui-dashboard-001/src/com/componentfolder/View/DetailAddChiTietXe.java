...
public class DetailAddChiTietXe extends javax.swing.JDialog {
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        if (mess == JOptionPane.YES_OPTION) {
            ...
            ctx.setBienSo(bienSo);
            ctx.setLoaiXe(loaiXe);
            ctx.setMoTa(moTa);
            ctx.setTinhTrang(tinhTrang);
            if (repo.updatechitietxe(ctx)) {
                JOptionPane.showMessageDialog(this, "update chi tiet xe thanh cong");
            } else {
                JOptionPane.showMessageDialog(this, "update chi tiet xe that bai");
            }
            this.dispose();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (mess == JOptionPane.YES_OPTION) {
            ...
            ctx.setMoTa(moTa);
            ctx.setTinhTrang(tinhTrang);
            if (repo.insertchitietxe(ctx)) {
                JOptionPane.showMessageDialog(this, "insert chi tiet xe thanh cong");
            } else {
                JOptionPane.showMessageDialog(this, "insert chi tiet xe that bai");
            }
            this.dispose();
        }
